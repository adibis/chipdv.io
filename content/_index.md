...
<div class="not-prose chipdv-hero" style="background: var(--chipdv-home-dark); color: #fff;">
  <div style="max-width: 1400px; margin: 0 auto; padding: 3rem 3rem 2.75rem;">
    ...
    <div style="display: flex; gap: 0.9rem; margin-top: 1.6rem; align-items: center; flex-wrap: wrap;">
      <a href="/csr/ral-fundamentals/" style="font: 600 0.875rem var(--font-sans); background: #df8e1d; color: #18181b; padding: 0.75rem 1.5rem; border-radius: 0.4rem; text-decoration: none;">Start with UVM RAL Fundamentals &rarr;</a>
...
<div class="not-prose" style="max-width: 1400px; margin: 0 auto; padding: 2.25rem 0 0;">
  ...
  <div class="chipdv-series-grid">
    <div class="chipdv-series-card chipdv-series-placeholder">
      <div class="chipdv-series-title">More projects on the way</div>
      <div class="chipdv-series-desc">Reusable UVM components and scripts as the writing grows.</div>
    </div>
  </div>
</div>
